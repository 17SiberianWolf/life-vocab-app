-- ==========================================================
-- life-vocab-app · Supabase Schema (阶段 5)
-- ==========================================================
-- 适用对象: 任意 Supabase 项目(Postgres 15+)
-- 创建方式: Supabase Dashboard → SQL Editor → 粘贴执行
...
-- ------------------------------------------------------------
-- 创建完成后,Anon Key 只需要 SELECT/INSERT/UPDATE/DELETE 本表
